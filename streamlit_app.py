...
if os.path.exists(LOG_PATH):
    try:
        ...
        fig.add_hline(y=0.1, line=dict(color='orange', dash='dash'), 
                      annotation_text="Possible Drift (0.1)", annotation_position="top left")
        fig.add_hline(y=0.25, line=dict(color='red', dash='dash'), 
                      annotation_text="Likely Drift (0.25)", annotation_position="top left")
